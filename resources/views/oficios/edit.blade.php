...
<div class="container">  
  <form method="POST" id="qs" action="{{ url('/oficios/'.$id)}}">
    @method('PUT')
    @csrf
    <h3>Actualizar Estado</h3>
    <h5>Selecciona un estado para actualizar la solicitud.</h5>
    <fieldset>
    {!! Form::select('estado', $estados, $oficio->estado, ['class' => 'form-control']) !!}
    </fieldset>

    <fieldset>
      <button name="submit" type="submit"  data-submit="...Guardando">Actualizar Estado</button>
    </fieldset>
  </form> 
</div>
@endsection
