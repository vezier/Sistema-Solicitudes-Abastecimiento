...
<div class="container">  
  <form method="GET" id="qs"action="{{ route('showO') }}">
    @method('GET')
    @csrf
    <h3>Busqueda Rapida</h3>
    <h4></h4>
    <fieldset>
      <input placeholder="Insertar RBD Establecimiento" type="text" name="rbd" tabindex="1" required autofocus>
    </fieldset>
    <fieldset>
      <button name="submit" type="submit"  data-submit="...Buscando">Buscar</button>
    </fieldset>
  </form> 
</div>